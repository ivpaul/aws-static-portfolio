    ...
    <div class="project-list">
      <a href="https://github.com/ivpaul/home-library" class="project-link">
        <div class="project-item">
          ...
          <p>Building this project to gain more exposure to AWS services -- specifically the Command-Line-Interface (CLI), Cognito, API Gateway, and Virtual Private Cloud (VPC) -- and continue practicing cloud development best practices. This library app is incomplete; my next steps are to incorporate terraform to handle infrastructure and automation to upload all of my books to the app.</p>
